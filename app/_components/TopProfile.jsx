...
=======
            <div className='flex flex-col gap-5 items-center lg:items-start justify-center border-b border-[var(--gray-color-2)] pb-5'>
                <div className='flex flex-col items-center lg:items-start justify-center gap-2.5'>
                    <div className="w-full flex items-center lg:justify-start justify-center">
                        <div className='lg:size-24 size-20 overflow-hidden relative'>
>>>>>>> origin/develop
...
<<<<<<< HEAD
                    <div className='flex flex-col items-center lg:items-start justify-center gap-1.5'>
                        <h4 className='mb-0 font-bold'>Karan Kumbhare</h4>
                        <h6 className='mb-0 text-base primary-gradient'>Full-Stack Developer</h6>
                    </div>
                </div>
...
=======
                    <div className='flex flex-col items-center lg:items-start justify-center gap-1'>
                        <h5 className='!text-xl'>Karan Kumbhare</h5>
                        <h6 className='!text-sm primary-gradient'>Full-Stack Developer</h6>
                    </div>
                </div>
                <div className='flex items-center justify-center lg:justify-start'>
...
<<<<<<< HEAD
                        ...
                        <span className='quote-right-icon absolute right-0 bottom-1/4 h-3 w-3'>
=======

                        </span>
                        <span className='inline px-5'>
                            Code is today&apos;s ink for writing tomorrow !!
                        </span>
