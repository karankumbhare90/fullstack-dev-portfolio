            ...
            <div className='flex flex-col gap-2 items-center lg:items-start justify-center border-b border-slate-300 pb-5'>
                <div className='flex flex-col items-center lg:items-start justify-center gap-2.5'>
                    <div className="w-full flex items-center lg:justify-start justify-center">
                        <div className='lg:size-32 size-40 overflow-hidden relative'>
                            <Image loading='lazy' src={profileImage} alt='Profile' fill className='w-full h-full object-cover rounded-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-center lg:items-start justify-center gap-1.5'>
                        <p className='text-lg lg:text-2xl mb-0 font-semibold text-black'>{name}</p>
                        <p className='mb-0 text-sm lg:text-base font-medium primary-gradient'>{currentDesignation}</p>
                    </div>
                </div >
                <div className='flex items-center justify-center lg:justify-start'>
                    <div className='inline-flex font-medium relative px-5'>
                        ...
                        <span className='inline text-sm text-gray-700'>
                            {parse(quote)}
                        </span>
